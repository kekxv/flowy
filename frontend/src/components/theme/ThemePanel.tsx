...
export default function ThemePanel() {
  ...
  return <details className="relative"><summary className="flex cursor-pointer list-none items-center gap-2 rounded-lg px-2.5 py-2 text-[13px] font-medium text-[var(--text-muted)] hover:bg-[var(--bg-hover)]"><Palette size={16}/><span className="hidden xl:inline">Theme</span></summary>
    <div className="absolute bottom-0 left-full z-50 ml-2 w-56 rounded-xl border border-[var(--border)] bg-white p-3 shadow-[var(--shadow-lg)]">
