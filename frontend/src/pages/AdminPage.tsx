      ...
      <div className="card rounded-xl overflow-hidden">
        ...
        <form onSubmit={saveOAuthConfig} className="px-5 py-4 space-y-4">
          ...
          <div className="rounded-lg bg-[var(--primary-light)] px-3 py-2.5 text-[11px] text-[var(--primary)]">
            ...
            <code className="ml-2 rounded bg-white/60 px-1.5 py-0.5 font-mono text-[10px] select-all">{(oauthConfig["frontend_url"] || window.location.origin + window.location.pathname.replace(/\/?$/, "/")) + "api/v1/external/connections/oauth/callback"}</code>
          </div>
