...
down_revision: Union[str, None] = '972e94b14d0d'
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("priority IN ('critical','high','medium','low','trivial')", name='ck_issue_priority'),
    sa.CheckConstraint("status IN ('open','in_progress','resolved','closed','cancelled')", name='ck_issue_status'),
